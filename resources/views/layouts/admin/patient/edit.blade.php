            ...
            <div class="card">
               <div class="card-header p-2">
                  <ul class="nav nav-pills">
                     ...
                     <li class="nav-item"><a class="nav-link" href="#analysis1" data-toggle="tab">Analysis 1</a></li>
                     <li class="nav-item"><a class="nav-link" href="#analysis2" data-toggle="tab">Analysis 2</a></li>
                     <li class="nav-item"><a class="nav-link" href="#analysis3" data-toggle="tab">Analysis 3</a></li>
                     <li class="nav-item"><a class="nav-link" href="#analysis4" data-toggle="tab">Analysis 4</a></li>
                     <li class="nav-item"><a class="nav-link" href="#analysis5" data-toggle="tab">Analysis 5</a></li>
                     <li class="nav-item"><a class="nav-link" href="#analysis6" data-toggle="tab">Analysis 6</a></li>
                     <li class="nav-item"><a class="nav-link" href="#analysis7" data-toggle="tab">Analysis 7</a></li>
                     <li class="nav-item"><a class="nav-link" href="#analysis8" data-toggle="tab">Analysis 8</a></li>
                  </ul>
               </div>
               <!-- /.card-header -->
               <div class="card-body">
                     ...
                     <div class="tab-pane active" id="details">
                        <div class="post">
                           <div class="card card-info">
                              ...
                              <form role="form" enctype="multipart/form-data" id="storeUserForm" action="{{route('admin.patient.update', $patient)}}" method="POST" >
                                 @csrf
                                 {{ method_field('PUT') }}
                                 <div class="card-body">
                     ...
                     <div class="tab-pane" id="analysis1">
                        <div class="post">
                           <div class="card card-info">
                              ...
                              <form role="form" enctype="multipart/form-data" id="analysisForm1" action="{{route('admin.patient.analysis.first', $patient)}}" method="POST" >
                                 @csrf
                                 {{ method_field('PUT') }}
                                 <div class="card-body">
                     ...
                     <div class="tab-pane" id="analysis2">
                        <div class="post">
                           <div class="card card-info">
                              ...
                              <form role="form"  id="analysisForm2" action="{{route('admin.patient.analysis.second', $patient)}}" method="POST" >
                                 @csrf
                                 {{ method_field('PUT') }}
                                 <div class="card-body">
                     ...
                     <div class="tab-pane" id="analysis3">
                        <div class="post">
                           <div class="card card-info">
                              ...
                              <form role="form"  id="analysisForm3" action="{{route('admin.patient.analysis.third', $patient)}}" method="POST" >
                                 @csrf
                                 {{ method_field('PUT') }}
                                 <div class="card-body">
                     ...
                     <div class="tab-pane" id="analysis4">
                        <div class="post">
                           <div class="card card-info">
                              ...
                              <form role="form"  id="analysisForm4" action="{{route('admin.patient.analysis.fourth', $patient)}}" method="POST" >
                                 @csrf
                                 {{ method_field('PUT') }}
                                 <div class="card-body">
                                          ...
                                          <div class="tab-pane" id="analysis5">
                                             <div class="post">
                                                <div class="card card-info">
                                                   ...
                                                   <form role="form"  id="analysisForm5" action="{{route('admin.patient.analysis.fifth', $patient)}}" method="POST" >
                                                      @csrf
                                                      {{ method_field('PUT') }}
                                                      <div class="card-body">
                ...
                <div class="tab-pane" id="analysis6">
                   <div class="post">
                      <div class="card card-info">
                         ...
                         <form role="form"  id="analysisForm6" action="{{route('admin.patient.analysis.sixth', $patient)}}" method="POST" >
                            @csrf
                            {{ method_field('PUT') }}
                            <div class="card-body">
                                ...
                                <div class="tab-pane" id="analysis7">
                                   <div class="post">
                                      <div class="card card-info">
                                         ...
                                         <form role="form"  id="analysisForm7" action="{{route('admin.patient.analysis.seventh', $patient)}}" method="POST" >
                                            @csrf
                                            {{ method_field('PUT') }}
                                            <div class="card-body">
                      ...
                      <div class="tab-pane" id="analysis8">
                         <div class="post">
                            <div class="card card-info">
                               ...
                               <form role="form"  id="analysisForm8" action="{{route('admin.patient.analysis.eight', $patient)}}" method="POST" >
                                  @csrf
                                  {{ method_field('PUT') }}
                                  <div class="card-body">
