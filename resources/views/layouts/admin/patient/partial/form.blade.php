...
<div class = "row">
  <div class = "col-md-6">
    <div class="form-group">
      ...
      <input id="number" type="number" class="form-control @error('number') is-invalid @enderror" name="number" value="{{(isset($patient->number)) ? $patient->number: '' }}" placeholder="Number"    maxlength="10" size="10" readonly required>
    </div>
  </div>
  <div class = "col-md-6">
    <div class="form-group">
      <label>Email Address</label>
      <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{(isset($patient->email)) ? $patient->email: '' }}"  autocomplete="email" readonly required>
    ...
    <div class="form-group">
      <label>Date Of Birth:</label>
        <div class="input-group date" id="dob" data-target-input="nearest">
            <input type="text" class="form-control datetimepicker-input" data-target="#dob" name = "dob" readonly required/>
