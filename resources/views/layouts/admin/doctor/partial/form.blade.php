<div class = "row">
  ...
  <div class = "col-md-6">
    ...
    <div class="direct-chat-msg">
      <img class="direct-chat-img" src="{{ asset('storage/doctor/profile/'.$user->doctor->sign )}}" alt=""> &nbsp;&nbsp;&nbsp;
...
<div class = "row">
    ...
    <div class = "col-md-6">
      <div class="form-group">
        ...
        <input id="email" type="email" class="form-control" name="email" placeholder="Enter email" value="{{ $user->email }}">
      </div>
  </div>
</div>
<div class = "row">
