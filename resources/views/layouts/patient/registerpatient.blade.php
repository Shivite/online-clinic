  ...
  <div class="col-md-10">
      <div class="card card-primary card-outline special-card" >
          <div class="card-body box-profile">
            ...
            <form  enctype="multipart/form-data" id = "register-patient" action="{{route('patient.registration')}}" method="POST">
            @csrf
                <div class="row">
                  <div class="col-sm-2">
                  ...
                  <div class="col-sm-2">
                    <div class="form-group">
                      ...
                      <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{(isset($patient->name)) ? $patient->name: '' }}" placeholder="Name"  required >
                      @error('name')
                  ...
                  <div class="col-sm-4">
                    ...
                    <input id="number" type="number" class="form-control @error('number') is-invalid @enderror" name="number" value="{{(isset($patient->number)) ? $patient->number: '' }}" placeholder="Number"    maxlength="10" size="10" required>
                    @error('number')
                        <span class="invalid-feedback custom-err" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                  ...
                  <div class="col-sm-4">
                    ...
                    <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password"  autocomplete="new-password" placeholder="password" minlength="8"" required>
                    @error('password')
                        <span class="invalid-feedback custom-err" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{(isset($patient->email)) ? $patient->email: '' }}"  autocomplete="email" required>
                ...
                <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group">
                    <label>Address</label>
                    <textarea id="address" class="form-control @error('address') is-invalid @enderror" rows="5" name="address"  placeholder="Address" required > {{(isset($patient->address)) ? $patient->address: '' }} </textarea>
                    @error('address')
                        <span class="invalid-feedback custom-err" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                  ...
                  <div class="col-sm-3">
                    <div class="form-group">
                    <label>Pin</label>
                    <input  type="number" id="pin" class="form-control @error('pin') is-invalid @enderror" name="pin" value="{{(isset($patient->pin)) ? $patient->pin: '' }}" placeholder="Pin code" maxlength="6" size="6"  required >
                    @error('pin')
                        <span class="invalid-feedback custom-err" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                  ...
                  <div class="form-group">
                    ...
                    <input  type="text" id="legalgaurdian" class="form-control @error('legalgaurdian') is-invalid @enderror" name="legalgaurdian" value="{{(isset($patient->legalgaurdian)) ? $patient->legalgaurdian: '' }}" required>
                    @error('legalgaurdian')
                        <span class="invalid-feedback custom-err" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="form-group">
                      <label>Date Of Birth:</label>
                        <div class="input-group date" id="dob" data-target-input="nearest">
                            <input type="text" class="form-control datetimepicker-input" data-target="#dob" name = "dob" value = "{{(isset($patient->dob)) ? $patient->dob: '' }}" required/>
                ...
                <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <div class="custom-file" name = "photo">
                        <input type="file" class="custom-file-input @error('photo') is-invalid @enderror" id="customFile" name = "photo" required>
                  ...
                  <div class="form-group">
                    ...
                    <div class="custom-file">
                      <input id="countryproof" type="file" class="custom-file-input  @error('proof') is-invalid @enderror" id="customFile" name = "proof" required>
